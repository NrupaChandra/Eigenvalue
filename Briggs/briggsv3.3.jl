...
begin
    ...
    @everywhere function couetteflow_spatial_sing_mode_comparison(omega, alpha_approximation) # returs the cloest eigen value 
        #eigvals = couetteflow_temporal(alpha)
...
begin
    ...
    filename = "contour_iteration_commonzeta_4e-4_overlapcheckv2.json"
end
