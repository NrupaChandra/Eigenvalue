# briggsv4.6_ribbon.jl -- THE CLOSED LOOP. First version since the abandoned
...
# Run from vib_ribbon/src/:  julia briggsv4.6_ribbon.jl
...
begin
    ...
    filename = "contour_iteration_v4.6_ribbon.json"
end
